...
## In Progress
- Adaptive Execution & Context Efficiency v1: implementation and deterministic 50-case plan evaluation are complete; real paired full/adaptive task evidence is still required before changing the default from the previously accepted auto policy.
