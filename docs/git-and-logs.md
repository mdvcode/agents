...
- Flowfox branch names are public PR metadata. Use branch prefixes allowed by `.agent-policy.yaml`: `feat/`, `fix/`, `issue/`, or `tast/`. Do not include agents, Codex, AI, automation, private control-plane paths, or internal tooling names.
