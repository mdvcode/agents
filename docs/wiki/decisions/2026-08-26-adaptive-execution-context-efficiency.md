...
The task budget controller tracks model calls, uncached input, output, elapsed time, repairs, and escalations. It progresses from normal execution to economy pressure, optional-role shedding, and approval. It never skips a mandatory verification/security gate.
