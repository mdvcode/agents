...
- `decisions/2026-09-02-tweebit-projects.md`: trusted local project catalog, one-project/many-task identity, global task projection, and supported Codex workspace handoff.
