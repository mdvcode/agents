...
- `decisions/2026-09-03-effective-context-inspector.md`: source-revision cache safety, Effective Context digest, Inspector evidence, and reference-only trust labels.
