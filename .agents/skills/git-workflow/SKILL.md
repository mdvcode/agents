...
- Never stage or push private control-plane paths for a target project, including the active Harness control-plane checkout, `external/agents/`, `.agents/`, `artifacts/`, private issue journals, private memory/wiki/graph files, prompt files, skills, audit logs, or sensitive screenshot/video/trace artifacts.
